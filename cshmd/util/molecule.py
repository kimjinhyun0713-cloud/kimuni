...
molDic["H3O"] = np.array(
    [
        ["H", -0.9628884076877837, 0, -0.2698998227870565, "h*"],
...
molDic["OH"] = np.array([["H", 1, 0, 0, "h*"], ["O", 0, 0, 0, "o*"]], dtype=object)
molDic["CO3"] = np.array(
    [
        ["O", 0, 1.2, 0, "oc"],
...
molDic["IO3"] = np.array(
    [
        ...
        ["O", 0.8096500000000004, -0.77221, -1.4601600000000001, "O"],
    ],
    dtype=object,
)
molDic["H2O_CSH"] = np.array(
    [
        ["O", 0, 0, 0, "o*"],
        ["H", 0.58071, 0.0, 0.81412, "h*"],
        ["H", 0.58071, 0.0, -0.81411, "h*"],
    ],
    dtype=object,
)
